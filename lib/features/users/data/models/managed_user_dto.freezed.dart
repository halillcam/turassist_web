...
mixin _$ManagedUserDto {
  ...
  /// Create a copy of ManagedUserDto
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $ManagedUserDtoCopyWith<ManagedUserDto> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ManagedUserDtoCopyWith<$Res> {
  factory $ManagedUserDtoCopyWith(
    ManagedUserDto value,
    $Res Function(ManagedUserDto) then,
  ) = _$ManagedUserDtoCopyWithImpl<$Res, ManagedUserDto>;
  @useResult
  $Res call({
    String? uid,
    String fullName,
...
/// @nodoc
class _$ManagedUserDtoCopyWithImpl<$Res, $Val extends ManagedUserDto>
    implements $ManagedUserDtoCopyWith<$Res> {
  _$ManagedUserDtoCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$ManagedUserDtoImplCopyWith<$Res>
    implements $ManagedUserDtoCopyWith<$Res> {
  factory _$$ManagedUserDtoImplCopyWith(
    _$ManagedUserDtoImpl value,
    $Res Function(_$ManagedUserDtoImpl) then,
  ) = __$$ManagedUserDtoImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({
    String? uid,
...
/// @nodoc
class __$$ManagedUserDtoImplCopyWithImpl<$Res>
    extends _$ManagedUserDtoCopyWithImpl<$Res, _$ManagedUserDtoImpl>
    implements _$$ManagedUserDtoImplCopyWith<$Res> {
  __$$ManagedUserDtoImplCopyWithImpl(
    _$ManagedUserDtoImpl _value,
    $Res Function(_$ManagedUserDtoImpl) _then,
  ) : super(_value, _then);
...
class _$ManagedUserDtoImpl implements _ManagedUserDto {
  const _$ManagedUserDtoImpl({
    this.uid,
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$ManagedUserDtoImplCopyWith<_$ManagedUserDtoImpl> get copyWith =>
      __$$ManagedUserDtoImplCopyWithImpl<_$ManagedUserDtoImpl>(
        this,
        _$identity,
      );
}

abstract class _ManagedUserDto implements ManagedUserDto {
  const factory _ManagedUserDto({
    final String? uid,
