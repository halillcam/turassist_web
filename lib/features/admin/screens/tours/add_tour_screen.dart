...
class _AddTourScreenState extends State<AddTourScreen> {
  ...
  void _removeProgramDay(int index) {
    setState(() {
      _programDays.removeAt(index).dispose();
    });
  }
  ...
  Future<void> _pickDate() async {
    ...
    if (_selectedDates.any((d) => _isSameDay(d, normalized))) return;
      ...
      body: SingleChildScrollView(
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              _buildSectionHeader(Icons.info_outline, 'Temel Bilgiler'),
              const SizedBox(height: 16),
              _buildBasicInfoSection(),
              const SizedBox(height: 32),
              _buildSectionHeader(Icons.directions_bus, 'Araç Bilgileri'),
              const SizedBox(height: 16),
              _buildBusInfoSection(),
              const SizedBox(height: 32),
              _buildSectionHeader(Icons.calendar_month, 'Çıkış Takvimi'),
              const SizedBox(height: 16),
              _buildDepartureSection(),
              const SizedBox(height: 32),
              _buildSectionHeader(Icons.list_alt, 'Tur Programı'),
              const SizedBox(height: 16),
...
/// Tur programındaki bir gün için controller'lar.
class _ProgramDay {
